...
// console.log(firstName1.slice(3))//uri

// console.log(firstName1.slice(-2,1)) //""

// console.log(firstName1.slice(2,5))

// console.log(firstName1.slice(-6,-3))
...
// console.log(firstName1.charAt(9))//blank string

// //12. charCodeAt()
// console.log(firstName1.charCodeAt(0))

// console.log(firstName1.charCodeAt(10))//NaN

//13. split()
let firstName1="Mayuri-Katwe"
console.log(firstName1.split(""))
console.log(firstName1.split("-"))
console.log(firstName1.split("y"))
