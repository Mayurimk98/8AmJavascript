...
//Program 2
//find the fullName of all student whoes age is greate than 30
...
//by using filter()
let greter30 = student.filter(function (el) {
    return el.age > 30
})

console.log("==========================")
greter30.forEach(function (el) {
    console.log(el.firstName + el.lastName)
})
...
//Poggram 4
//find the firstName of student whoes city is pune
student.filter(function(el){
    return el.city=="Pune"
}).forEach(function(el){
